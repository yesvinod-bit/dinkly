...
- ✨ Polished the home pairing toggle, score feedback, mobile app shell, and live tournament presentation.
- 🔐 Updated Firebase rules and deploy config so production writes work on the correct Firestore database.
